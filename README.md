...
I based my contact form on the css styling as per the love running project.  My form takes a very simple design approach and is currently not linked to a database to receive the user-posted information.
